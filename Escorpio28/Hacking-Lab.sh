...
└══════════════════════┘\e[1;32m"
sleep 0.5
echo -e "\e[0;32m no recomendado se podria inhabilitar metasploit y tendrás que empezar desde cero. \e[0m" |pv -qL 8
sleep 1
echo -e "
\e[1;30m┌══════════════════════┐
...
└════════════════════┘\e[1;32m"
sleep 0.5
echo -e "\e[0;32m no reemplazar ni instalar ninguna versión inhabilitara metasploit. \e[0m" | pv -qL 8
sleep 1
echo -e "
\e[1;30m┌═══════════════════┐
